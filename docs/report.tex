...
\title{Practical Assignment – Machine Learning}
\author{Mazilu Cosmin-Alexandru \\ Mardare Andrei Daniel}
\date{\today}
...
\begin{itemize}
  ...
  \item Split pe bonuri: bonurile au fost despărțite in ordine temporala: primele 80\% din bonuri au fost folosite pentru antrenare si restul de 20\% au fost folosite pentru testare.
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.45\textwidth]{confusion_matrix_crazy.png}
    \includegraphics[width=0.45\textwidth]{roc_curve_crazy.png}
    \caption{Matricea de confuzie și Curba ROC pentru predicția Crazy Sauce}
    \label{fig:crazy_res}
\end{figure}
\begin{center}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.8\textwidth]{roc_curves_per_sauce.png}
    \caption{Curbe ROC comparative pentru modelele per-sos}
    \label{fig:persauce_roc}
\end{figure}
\begin{center}
\begin{tabular}{lcccc}
\toprule
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.8\textwidth]{ranking_hit_k.png}
    \caption{Performanța Hit@K pentru modelul de ranking vs baseline}
